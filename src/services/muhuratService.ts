...
export const FALLBACK_EVENT_TYPES: EventRuleInfo[] = [
  { id: 'marriage', name: 'Marriage (Vivaha)', sanskritName: 'विवाह संस्कार', icon: 'marriage', description: 'Sacred matrimonial ceremony uniting two lives.', favorableTithis: ['Dvitiya (2)', 'Tritiya (3)', 'Panchami (5)', 'Saptami (7)', 'Ekadashi (11)'], favorableNakshatras: ['Rohini', 'Mrigashirsha', 'Uttara Phalguni', 'Hasta', 'Revati'], favorableVaaras: ['Monday', 'Wednesday', 'Thursday', 'Friday'] },
  { id: 'housewarming', name: 'Griha Pravesh (Housewarming)', sanskritName: 'गृह प्रवेश', icon: 'housewarming', description: 'First auspicious entry into a new home.', favorableTithis: ['Dvitiya (2)', 'Tritiya (3)', 'Panchami (5)', 'Saptami (7)', 'Trayodashi (13)'], favorableNakshatras: ['Rohini', 'Chitra', 'Anuradha', 'Revati'], favorableVaaras: ['Monday', 'Wednesday', 'Thursday', 'Friday'] },
  { id: 'business', name: 'Business Inauguration', sanskritName: 'व्यापार आरम्भ', icon: 'business', description: 'Inauguration of commercial venture or office.', favorableTithis: ['Dvitiya (2)', 'Tritiya (3)', 'Panchami (5)', 'Dashami (10)'], favorableNakshatras: ['Ashwini', 'Pushya', 'Hasta', 'Chitra'], favorableVaaras: ['Wednesday', 'Thursday', 'Friday'] },
  { id: 'vehicle', name: 'Vehicle Purchase', sanskritName: 'वाहन क्रय', icon: 'vehicle', description: 'Auspicious acquisition of motor vehicle or transport asset.', favorableTithis: ['Dvitiya (2)', 'Tritiya (3)', 'Panchami (5)', 'Ekadashi (11)'], favorableNakshatras: ['Ashwini', 'Punarvasu', 'Pushya', 'Shravana'], favorableVaaras: ['Sunday', 'Monday', 'Thursday', 'Friday'] },
  { id: 'property', name: 'Property Registration', sanskritName: 'भूमि / जायदाद पंजीकरण', icon: 'property', description: 'Legal registration of land, real estate, or fixed assets.', favorableTithis: ['Dvitiya (2)', 'Tritiya (3)', 'Panchami (5)', 'Trayodashi (13)'], favorableNakshatras: ['Rohini', 'Magha', 'Uttara Phalguni', 'Revati'], favorableVaaras: ['Tuesday', 'Thursday', 'Friday'] },
  { id: 'travel', name: 'Yatra / Long Travel', sanskritName: 'यात्रा प्रारम्भ', icon: 'travel', description: 'Commencement of long-distance journey or foreign travel.', favorableTithis: ['Dvitiya (2)', 'Tritiya (3)', 'Panchami (5)', 'Saptami (7)'], favorableNakshatras: ['Ashwini', 'Pushya', 'Hasta', 'Anuradha'], favorableVaaras: ['Monday', 'Wednesday', 'Thursday', 'Friday'] },
  { id: 'interview', name: 'Interview / Exam', sanskritName: 'साक्षात्कार / परीक्षा', icon: 'interview', description: 'Important career interview or academic examination.', favorableTithis: ['Dvitiya (2)', 'Tritiya (3)', 'Panchami (5)', 'Dashami (10)'], favorableNakshatras: ['Ashwini', 'Rohini', 'Pushya', 'Swati'], favorableVaaras: ['Sunday', 'Wednesday', 'Thursday', 'Friday'] },
  { id: 'naming', name: 'Namakarana (Naming)', sanskritName: 'नामकरण संस्कार', icon: 'naming', description: 'Traditional naming ceremony for a newborn infant.', favorableTithis: ['Dvitiya (2)', 'Tritiya (3)', 'Panchami (5)', 'Ekadashi (11)'], favorableNakshatras: ['Rohini', 'Uttara Phalguni', 'Hasta', 'Anuradha'], favorableVaaras: ['Monday', 'Wednesday', 'Thursday', 'Friday'] },
  { id: 'general', name: 'General Auspicious', sanskritName: 'सामान्य शुभ कार्य', icon: 'general', description: 'General daily endeavors and contract signings.', favorableTithis: ['Dvitiya (2)', 'Tritiya (3)', 'Panchami (5)', 'Saptami (7)'], favorableNakshatras: ['Ashwini', 'Rohini', 'Pushya', 'Shravana'], favorableVaaras: ['Monday', 'Wednesday', 'Thursday', 'Friday'] },
];
